...
/**
 * depositLender function for copra-finance
 * @param props Function parameters
 * @param tools Blockchain interaction tools
 */
export async function depositLender(
    ...
    return toResult(
        result.isMultisig
            ? message.message
            : `Successfully executed depositLender. ${message.message}`
    );
}